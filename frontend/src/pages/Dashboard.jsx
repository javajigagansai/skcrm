...
export const Dashboard = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Date Filter Bar */}
      <div className="bg-white p-3.5 rounded-2xl border border-slate-200/80 shadow-card flex flex-col space-y-3">
        <div className="flex flex-wrap items-center gap-2">
          {/* 1. Custom Date (Prominent Highlighted Pill on the Left) */}
          <button 
            type="button"
            onClick={() => setDateFilter('CUSTOM')}
            className={`inline-flex items-center justify-center space-x-1.5 px-4 py-2 rounded-xl text-xs transition cursor-pointer min-h-[38px] ${
              dateFilter === 'CUSTOM'
                ? 'bg-blue-700 text-white shadow-md font-black ring-2 ring-blue-400/50'
                : 'bg-blue-600 hover:bg-blue-700 text-white shadow font-bold'
            }`}
          ...
          <button 
            ...
            className={`px-3.5 py-2 rounded-xl text-xs transition cursor-pointer min-h-[38px] flex items-center justify-center ${
              dateFilter === 'TODAY'
